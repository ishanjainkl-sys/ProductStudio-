...
export async function list(req: Request, res: Response, next: NextFunction) {
  try {
    const data = await service.listPages(req.params.projectId!, req.user!.id);
    res.json({ data });
  } catch (err) {
    next(err);
  }
...
export async function create(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    const data = await service.createPage(req.params.projectId!, req.user!.id, body);
...
export async function get(req: Request, res: Response, next: NextFunction) {
  try {
    const data = await service.getPage(req.params.id!, req.user!.id);
    res.json({ data });
  } catch (err) {
    next(err);
  }
...
export async function update(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    const data = await service.updatePage(req.params.id!, req.user!.id, body);
    res.json({ data });
  } catch (err) {
    next(err);
  }
...
export async function duplicate(req: Request, res: Response, next: NextFunction) {
  try {
    const data = await service.duplicatePage(req.params.id!, req.user!.id);
    res.status(201).json({ data });
  } catch (err) {
    next(err);
  }
...
export async function reorder(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    const data = await service.reorderPages(req.params.projectId!, req.user!.id, body.pageIds);
    res.json({ data });
  } catch (err) {
    next(err);
  }
...
export async function exportPage(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    const data = await exportService.exportPage(req.params.id!, req.user!.id, body.format);
    res.json({ data });
  } catch (err) {
    next(err);
  }
