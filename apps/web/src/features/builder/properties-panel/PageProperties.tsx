...
export function PageProperties() {
    ...
    return (
        <div className="flex h-full flex-col bg-white dark:bg-[#111]" onWheel={(e) => e.stopPropagation()}>
            <div className="border-b border-neutral-100 dark:border-white/5 px-4 py-3 flex-none">
            ...
            <div className="p-4 space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    <div className="rounded-lg border border-neutral-200 bg-neutral-50 px-3 py-3 text-sm text-foreground dark:border-white/10 dark:bg-[#1a1a1a]">
